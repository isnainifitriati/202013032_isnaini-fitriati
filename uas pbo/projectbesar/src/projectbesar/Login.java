...
public class Login extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 1615, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void MasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MasukActionPerformed
        String dataku[]={"isnaini fitriati","2000"};
        if(NAMA.getText().equals(dataku[0])&&PW.getText().equals(dataku[1])){
            Daftarbusana DB=new Daftarbusana();
            DB.setVisible(true);
            this.dispose();
        }
...
public void kotak_pesan(){
    int dialogButton = JOptionPane.showConfirmDialog(null, "Yakin Mau Keluar?", "PERINGATAN",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.WARNING_MESSAGE);
